package com.vogella.tasks.ui.ownannotation;
...
public @interface DirectTodo {
	 ...
	 * <br/>
	 * Without parameter the injected Todo is an absent java.util.Optional, because
	 * Todo ids begin with 1 and the default is 0 (see ITodoService).
	 *
